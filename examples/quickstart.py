...
def main() -> None:
    ...
    # CPU is the stable default. See docs/vignettes/04_gpu_backend.md for CUDA
    # FISTA, hybrid fitting, Auto selection, and fallback behavior.
    ...
    print("fit timings:", clf.fit_timings_)
    if clf.rectify:
